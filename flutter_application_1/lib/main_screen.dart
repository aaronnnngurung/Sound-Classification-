          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                // Detect tab — same size as the others now. The big,
                // clearly-visible listening indicator lives on the
                // Home tab's status card instead, so this doesn't
                // need to be an oversized standout anymore.
                _buildNavItem(
                  index: 2,
